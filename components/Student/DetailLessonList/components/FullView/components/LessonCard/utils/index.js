...
export const renderDropdownOptions = (status, handleAssignLesson, handleRescheduleModalOpen, handleUnassignLesson, id) => {
  if (status === "SCHEDULED" || status === "ASSIGNED") {
    return (
      <React.Fragment>
        ...
        <li>
          <a href="#!" onClick={() => handleUnassignLesson([id])}>Unassign</a>
        </li>
      </React.Fragment>
    );
  }
