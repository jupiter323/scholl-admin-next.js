...
}), external_react_default.a.createElement("title", null, "Clear Choice Test Prep"));
...
// CONCATENATED MODULE: ./components/Core/SideNav.js
...
class SideNav_SideNav extends external_react_["Component"] {
  constructor(props) {
    super(props);
    this.props = props;
    this.state = {
  ...
  componentDidMount() {
    external_jquery_default()('.sidenav').sidenav();
  }
  ...
  render() {
    ...
    })), external_react_default.a.createElement("ul", null, menuItems.map(menuItem => external_react_default.a.createElement("li", {
    ...
    }), menuItem.key.charAt(0).toUpperCase() + menuItem.key.slice(1)))))), external_react_default.a.createElement("div", {
    ...
    }, "Log Out")), external_react_default.a.createElement(link_default.a, {
      href: "/account"
...
/* harmony default export */ var Core_SideNav = (SideNav_SideNav);
...
class Page_Page extends external_react_["Component"] {
  render() {
    return external_react_default.a.createElement(external_styled_components_["ThemeProvider"], {
      theme: theme
    }, external_react_default.a.createElement(StyledPage, null, external_react_default.a.createElement(components_Meta, null), external_react_default.a.createElement("div", {
      className: "wrapper"
    }, external_react_default.a.createElement(Core_SideNav, {
      user: sampleInstructors["a" /* default */][0]
    }), external_react_default.a.createElement(Inner, null, this.props.children)), external_react_default.a.createElement("script", {
...
class _app_ClearChoice extends app_default.a {
  render() {
    const {
      Component
    } = this.props;
    return external_react_default.a.createElement(app["Container"], null, external_react_default.a.createElement(components_Page, null, external_react_default.a.createElement(Component, null)));
  }

}

/* harmony default export */ var _app = __webpack_exports__["default"] = (_app_ClearChoice);
