...
export const MARK_ALL_FLAGS_REVIEWED = 'MARK_ALL_FLAGS_REVIEWED';
...
export const UPDATE_TEST_ASSIGNMENT_DATE = 'UPDATE_TEST_ASSIGNMENT_DATE';
export const UPDATE_TEST_DUE_DATE = 'UPDATE_TEST_DUE_DATE';
...
export const COMPLETE_LESSON_SECTION = 'COMPLETE_LESSON_SECTION';
export const SUBMIT_LESSON_PROBLEMS = 'SUBMIT_LESSON_PROBLEMS';
export const FETCH_LESSON_DETAILS = 'FETCH_LESSON_DETAILS';
export const COMPLETE_SECTION_SUCCESS = 'COMPLETE_SECTION_SUCCESS';
export const FLAG_STUDENT_LESSON_SUCCESS = 'FLAG_STUDENT_LESSON_SUCCESS';
export const MARK_ALL_LESSON_FLAGS_REVIEWED = 'MARK_ALL_LESSON_FLAGS_REVIEWED';
export const RESET_LESSON_FLAG_COUNT = 'RESET_LESSON_FLAG_COUNT';
export const UPDATE_LESSON_SCORE = 'UPDATE_LESSON_SCORE';
export const UPDATE_TEST_FLAG_COUNT = 'UPDATE_TEST_FLAG_COUNT';
export const SET_LESSON_PAGINATION = 'SET_LESSON_PAGINATION';
