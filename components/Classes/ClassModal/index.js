...
class ClassModal extends React.Component {
  ...
  render() {
    ...
    const { deleteLocationModalOpen, newLocationModalOpen, editLocationModalOpen,
      } = this.state;
    return (
                                  ...
                                  <div className="col s12">
                                    <div className="check-holder">
                                      ...
                                      <span className="card-note">
                                        Select this option when you no longer
                                        want this student to appear on your list
                                        of current students. All student data is
                          ...
                          <div className="card-block">
                            ...
                            <div className="card-main card card-instructor">
                              <div className="card-content">
                                <div className="text-block">
                                  <p>
                                    Add one or more instructors to the list
                                    below. Each instructor can manage the
                                    coursework.
                                  </p>
                                </div>
                                <div className="box-scrollable">
