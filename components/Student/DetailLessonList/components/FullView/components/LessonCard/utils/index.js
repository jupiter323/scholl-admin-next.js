...
export const renderDropdownOptions = (status, handleAssignLesson, handleRescheduleModalOpen, handleUnassignLesson) => {
  ...
  return (
    <React.Fragment>
      ...
      <li>
        <a href="#!" onClick={handleUnassignLesson}>Unassign</a>
      </li>
    </React.Fragment>
  );
};
